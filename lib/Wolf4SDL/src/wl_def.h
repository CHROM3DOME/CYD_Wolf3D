...
#include <stdio.h>
#include <stdlib.h>
#include "wolf3d_keymap.h"  /* WolfMap<>: drop-in-replacement für std::unordered_map */
#if !defined(_WIN32)
#	include <stdint.h>
#	include <string.h>
#	include <stdarg.h>
...
/* stdio FILE*-Redirect: alle Wolf-Sources die fopen/fread/fseek/etc.
 * benutzen, gehen über unsere wolf_*-Wrapper auf Furi-Storage. Steht am
 * Ende der include-Kaskade, nach <stdio.h>, sonst Konflikt mit den
 * Newlib-Deklarationen. */
#define fopen(p, m)        ((FILE*)wolf_fopen((p), (m)))
#define fclose(f)          wolf_fclose((WolfFile*)(f))
#define fread(b, s, n, f)  wolf_fread((b), (s), (n), (WolfFile*)(f))
#define fwrite(b, s, n, f) wolf_fwrite((b), (s), (n), (WolfFile*)(f))
#define fseek(f, o, w)     wolf_fseek((WolfFile*)(f), (o), (w))
#define ftell(f)           wolf_ftell((WolfFile*)(f))
#define feof(f)            wolf_feof((WolfFile*)(f))
...
/* T-Embed-Anpassung: Spielgeschwindigkeit auf ~75 % gesenkt — mit Encoder
 * als Vorwärts-Trigger ist Original-Speed (35/70) zu schnell zu steuern. */
#define BASEMOVE                26   /* war 35, ~75% */
#define RUNMOVE                 53   /* war 70, ~75% */
#define BASETURN                35
#define RUNTURN                 70
